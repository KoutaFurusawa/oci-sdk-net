...
namespace OCISDK.Core.src.Identity
{
    public class IdentityClientAsync : ServiceClient, IIdentityClientAsync
    {
        ...
        public async Task<CreateCompartmentResponse> CreateCompartment(CreateCompartmentRequest createRequest)
        {
            ...
            var webResponse = await this.RestClientAsync.Post(uri, createRequest.CreateCompartmentDetails, createRequest.OpcRetryToken);
        ...
        public async Task<CreateTagNamespaceResponse> CreateTagNamespace(CreateTagNamespaceRequest createRequest)
        {
            ...
            var webResponse = await this.RestClientAsync.Post(uri, createRequest.CreateTagNamespaceDetails, createRequest.OpcRetryToken);
        ...
        public async Task<CreateTagResponse> CreateTag(CreateTagRequest createRequest)
        {
            ...
            var webResponse = await this.RestClientAsync.Post(uri, createRequest.CreateTagDetails, createRequest.OpcRetryToken);
        ...
        public async Task<CreatePolicyResponse> CreatePolicy(CreatePolicyRequest createPolicyRequest)
        {
            ...
            var webResponse = await this.RestClientAsync.Post(uri, createPolicyRequest.CreatePolicyDetails, createPolicyRequest.OpcRetryToken);
        ...
        public async Task<ChangeTagNamespaceCompartmentResponse> ChangeTagNamespaceCompartment(ChangeTagNamespaceCompartmentRequest request)
        {
            ...
            var webResponse = await this.RestClientAsync.Post(uri, request.ChangeTagNamespaceCompartmentDetail, request.OpcRetryToken);
        ...
        public async Task<UpdateCompartmentResponse> UpdateCompartment(UpdateCompartmentRequest updateRequest)
        {
            ...
            var webResponse = await this.RestClientAsync.Put(uri, updateRequest.UpdateCompartmentDetails, updateRequest.IfMatch);
