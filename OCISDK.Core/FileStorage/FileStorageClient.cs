...
namespace OCISDK.Core.FileStorage
{
    ...
    /// FileStorageClient
    /// </summary>
    public class FileStorageClient : ServiceClient, IFileStorageClient
    {
        ...
        /// Constructer
        /// </summary>
        public FileStorageClient(ClientConfig config) : base(config)
        {
        ...
        /// Constructer
        /// </summary>
        public FileStorageClient(ClientConfigStream config) : base(config)
        {
            ServiceName = FileStorageServiceName;
        }
