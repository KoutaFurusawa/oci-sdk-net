...
namespace OCISDK.Core.FileStorage
{
    ...
    public interface IFileStorageClientAsync : IClientSetting
    {
        ...
        /// <returns></returns>
        Task<ChangeFileSystemCompartmentResponse> ChangeFileSystemCompartment(ChangeFileSystemCompartmentRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CreateFileSystemResponse> CreateFileSystem(CreateFileSystemRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<UpdateFileSystemResponse> UpdateFileSystem(UpdateFileSystemRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<GetFileSystemResponse> GetFileSystem(GetFileSystemRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<ListFileSystemsResponse> ListFileSystems(ListFileSystemsRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DeleteFileSystemResponse> DeleteFileSystem(DeleteFileSystemRequest request);
    }
}
