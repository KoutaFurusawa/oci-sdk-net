...
namespace OCISDK.Core.ObjectStorage.Request
{
    ...
    public class CreateMultipartUploadRequest
    {
        ...
        /// object already exists. For creating and committing a multipart upload, this is the entity tag of the target object. 
        ...
        /// <summary>
        /// The request body must contain a single CreateMultipartUploadDetails resource.
        /// </summary>
