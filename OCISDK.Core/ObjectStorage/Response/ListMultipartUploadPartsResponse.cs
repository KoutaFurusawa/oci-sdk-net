...
{
    /// <summary>
    /// ListMultipartUploadParts response
    /// </summary>
    public class ListMultipartUploadPartsResponse
    {
        ...
        /// <summary>
        /// The response body will contain an array of MultipartUploadPartSummary resources.
        /// </summary>
        public List<MultipartUploadPartSummary> Items;
    }
}
