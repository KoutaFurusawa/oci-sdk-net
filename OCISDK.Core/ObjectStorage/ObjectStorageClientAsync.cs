...
namespace OCISDK.Core.ObjectStorage
{
    ...
    public class ObjectStorageClientAsync : ServiceClient, IObjectStorageClientAsync
    {
        ...
        public async Task<GetBucketResponse> GetBucket(GetBucketRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Get(uri, httpRequestHeaderParam, request.Fields))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<CreateBucketResponse> CreateBucket(CreateBucketRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.CreateBucketDetails, new HttpRequestHeaderParam() { OpcClientRequestId = request.OpcClientRequestId }))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<RenameObjectResponse> RenameObject(RenameObjectRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.RenameObjectDetails, new HttpRequestHeaderParam() { OpcClientRequestId = request.OpcClientRequestId }))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<RestoreObjectsResponse> RestoreObjects(RestoreObjectsRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.RestoreObjectsDetails, new HttpRequestHeaderParam() { OpcClientRequestId = request.OpcClientRequestId }))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<UpdateNamespaceMetadataResponse> UpdateNamespaceMetadata(UpdateNamespaceMetadataRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.UpdateNamespaceMetadataDetails, new HttpRequestHeaderParam() { OpcClientRequestId = request.OpcClientRequestId }))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<UpdateBucketResponse> UpdateBucket(UpdateBucketRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.UpdateBucketDetails, httpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<PutObjectResponse> PutObject(PutObjectRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Put(uri, request.UploadPartBody, HttpRequestHeaderParam, false, false))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<UploadPartResponse> UploadPart(UploadPartRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Put(uri, request.UploadPartBody, HttpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<PutObjectLifecyclePolicyResponse> PutObjectLifecyclePolicy(PutObjectLifecyclePolicyRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Put(uri, request.PutObjectLifecyclePolicyDetails, HttpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<CreateMultipartUploadResponse> CreateMultipartUpload(CreateMultipartUploadRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.CreateMultipartUploadDetails, HttpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<CommitMultipartUploadResponse> CommitMultipartUpload(CommitMultipartUploadRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.CommitMultipartUploadDetails, HttpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<CreatePreauthenticatedRequestResponse> CreatePreauthenticatedRequest(CreatePreauthenticatedRequestRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.CreatePreauthenticatedRequestDetails, HttpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<AbortMultipartUploadResponse> AbortMultipartUpload(AbortMultipartUploadRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Delete(uri, new HttpRequestHeaderParam() { OpcClientRequestId = request.OpcClientRequestId }))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<CancelWorkRequestResponse> CancelWorkRequest(CancelWorkRequestRequest request)
        {
            var uri = new Uri($"{GetEndPointNoneVersion("workRequests", this.Region)}/{request.WorkRequestId}");
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<ListWorkRequestErrorsResponse> ListWorkRequestErrors(ListWorkRequestErrorsRequest request)
        {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<ListWorkRequestLogsResponse> ListWorkRequestLogs(ListWorkRequestLogsRequest request)
        {
