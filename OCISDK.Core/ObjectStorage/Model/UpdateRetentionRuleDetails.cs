...
namespace OCISDK.Core.ObjectStorage.Model
{
    ...
    public class UpdateRetentionRuleDetails
    {
        ...
        /// Once a rule is locked, only increases in the duration are allowed and no other properties can be changed. This property 
        /// cannot be updated for rules that are in a locked state. Specifying it when a duration is not specified is considered an error.
        /// <para>Required: no</para>
        /// </summary>
