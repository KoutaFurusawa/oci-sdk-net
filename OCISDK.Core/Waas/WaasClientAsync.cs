...
namespace OCISDK.Core.Waas
{
    ...
    public class WaasClientAsync : ServiceClient, IWaasClientAsync
    {
        ...
        /// Constructer
        /// </summary>
        public WaasClientAsync(ClientConfig config, IOciSigner ociSigner) : base(config, ociSigner)
        {
            ServiceName = WaasServiceName;
        }
        ...
        /// Constructer
        /// </summary>
        public WaasClientAsync(ClientConfigStream config, IOciSigner ociSigner) : base(config, ociSigner)
        {
            ServiceName = WaasServiceName;
        }
        ...
        public async Task<ChangeWaasPolicyCompartmentResponse> ChangeWaasPolicyCompartment(ChangeWaasPolicyCompartmentRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.ChangeWaasPolicyCompartmentDetails, httpRequestHeaderParam))
        ...
        public async Task<CreateWaasPolicyResponse> CreateWaasPolicy(CreateWaasPolicyRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Post(uri, request.CreateWaasPolicyDetails, httpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
        ...
        public async Task<UpdateWaasPolicyResponse> UpdateWaasPolicy(UpdateWaasPolicyRequest request)
        {
            ...
            using (var webResponse = await this.RestClientAsync.Put(uri, request.UpdateWaasPolicyDetails, httpRequestHeaderParam))
            using (var stream = webResponse.GetResponseStream())
            using (var reader = new StreamReader(stream))
            {
                var response = await reader.ReadToEndAsync();
