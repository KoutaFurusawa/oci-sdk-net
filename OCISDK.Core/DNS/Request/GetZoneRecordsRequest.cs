...
namespace OCISDK.Core.DNS.Request
{
    ...
    public class GetZoneRecordsRequest
    {
        ...
        public class SortByParam : ExpandableEnum<SortByParam>
        {
            ...
            /// domain
            /// </summary>
            public static readonly SortByParam Domain = new SortByParam("domain");
        ...
        public string GetOptionQuery()
        {
            ...
            {
                sb.Append($"{chainStr}domain={this.Domain}");
                chainStr = "&";
            }

            if (!String.IsNullOrEmpty(this.DomainContains))
            {
                sb.Append($"{chainStr}domainContains={this.DomainContains}");
                chainStr = "&";
            }
            ...
            if (!(SortBy is null))
            {
                sb.Append($"{chainStr}sortBy={SortBy.Value}");
                chainStr = "&";
            }
