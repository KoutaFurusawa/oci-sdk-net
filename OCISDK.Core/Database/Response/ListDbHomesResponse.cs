...
{
    /// <summary>
    /// ListDbHomes Response
    /// </summary>
    public class ListDbHomesResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// The response body will contain an array of DbHomeSummary resources.
        /// </summary>
        public List<DbHomeSummary> Items { get; set; }
    }
}
