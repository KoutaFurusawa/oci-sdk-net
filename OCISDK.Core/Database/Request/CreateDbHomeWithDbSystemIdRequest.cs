...
namespace OCISDK.Core.Database.Request
{
    ...
    public class CreateDbHomeWithDbSystemIdRequest
    {
        ...
        /// <summary>
        /// The request body must contain a single CreateDbHomeWithDbSystemIdDetails resource.
        /// </summary>
        public CreateDbHomeWithDbSystemIdDetails CreateDbHomeWithDbSystemIdDetails { get; set; }
    }
}
