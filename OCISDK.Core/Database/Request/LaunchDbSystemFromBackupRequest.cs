...
{
    /// <summary>
    /// LaunchDbSystemFromBackup Request
    /// </summary>
    public class LaunchDbSystemFromBackupRequest
    {
        /// <summary>
        ...
        /// </summary>
        public LaunchDbSystemFromBackupDetails LaunchDbSystemFromBackupDetails { get; set; }
    }
}
