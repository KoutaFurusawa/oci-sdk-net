...
{
    /// <summary>
    /// ListAppCatalogListings response
    /// </summary>
    public class ListAppCatalogListingsResponse
    {
        ...
        /// <summary>
        /// The response body will contain an array of AppCatalogListingSummary resources.
        /// </summary>
        public List<AppCatalogListingSummary> Items { get; set; }
    }
}
