...
{
    /// <summary>
    /// ListAppCatalogListingResourceVersions response
    /// </summary>
    public class ListAppCatalogListingResourceVersionsResponse
    {
        ...
        /// <summary>
        /// The response body will contain an array of AppCatalogListingResourceVersionSummary resources.
        /// </summary>
        public List<AppCatalogListingResourceVersionSummary> Items { get; set; }
    }
}
