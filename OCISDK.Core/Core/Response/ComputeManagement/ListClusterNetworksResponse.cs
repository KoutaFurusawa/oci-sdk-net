...
{
    /// <summary>
    /// ListClusterNetworks response
    /// </summary>
    public class ListClusterNetworksResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// The response body will contain an array of ClusterNetworkSummary resources.
        /// </summary>
        public List<ClusterNetworkSummary> Items { get; set; }
    }
}
