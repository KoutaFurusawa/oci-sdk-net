...
{
    /// <summary>
    /// ChangeVlanCompartment request
    /// </summary>
    public class ChangeVlanCompartmentRequest
    {
        /// <summary>
        /// For optimistic concurrency control. In the PUT or DELETE call for a resource, set the if-match parameter to the 
        /// value of the etag from a previous GET or POST response for that resource. The resource will be updated or deleted only 
        ...
        /// <summary>
        /// The request body must contain a single ChangeVlanCompartmentDetails resource.
        /// </summary>
