...
namespace OCISDK.Core.Core
{
    ...
    /// </summary>
    public interface IBlockstorageClientAsync : IClientSetting
    {
        /// <summary>
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ListVolumesResponse> ListVolumes(ListVolumesRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ListVolumeBackupsResponse> ListVolumeBackups(ListVolumeBackupsRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ListVolumeBackupPoliciesResponse> ListVolumeBackupPolicies(ListVolumeBackupPoliciesRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ListVolumeGroupsResponse> ListVolumeGroups(ListVolumeGroupsRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ListVolumeGroupBackupsResponse> ListVolumeGroupBackups(ListVolumeGroupBackupsRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeBackupPolicyAssetAssignmentResponse> GetVolumeBackupPolicyAssetAssignment(GetVolumeBackupPolicyAssetAssignmentRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeResponse> GetVolume(GetVolumeRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeBackupResponse> GetVolumeBackup(GetVolumeBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeBackupPolicyResponse> GetVolumeBackupPolicy(GetVolumeBackupPolicyRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeBackupPolicyAssignmentResponse> GetVolumeBackupPolicyAssignment(GetVolumeBackupPolicyAssignmentRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeGroupResponse> GetVolumeGroup(GetVolumeGroupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeGroupBackupResponse> GetVolumeGroupBackup(GetVolumeGroupBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<GetVolumeKmsKeyResponse> GetVolumeKmsKey(GetVolumeKmsKeyRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ChangeVolumeCompartmentResponse> ChangeVolumeCompartment(ChangeVolumeCompartmentRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ChangeVolumeBackupCompartmentResponse> ChangeVolumeBackupCompartment(ChangeVolumeBackupCompartmentRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<ChangeVolumeGroupCompartmentResponse> ChangeVolumeGroupCompartment(ChangeVolumeGroupCompartmentRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<CreateVolumeResponse> CreateVolume(CreateVolumeRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<CreateVolumeBackupResponse> CreateVolumeBackup(CreateVolumeBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<CreateVolumeBackupPolicyAssignmentResponse> CreateVolumeBackupPolicyAssignment(CreateVolumeBackupPolicyAssignmentRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<CreateVolumeGroupResponse> CreateVolumeGroup(CreateVolumeGroupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<CreateVolumeGroupBackupResponse> CreateVolumeGroupBackup(CreateVolumeGroupBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<UpdateVolumeResponse> UpdateVolume(UpdateVolumeRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<UpdateVolumeBackupResponse> UpdateVolumeBackup(UpdateVolumeBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<UpdateVolumeGroupResponse> UpdateVolumeGroup(UpdateVolumeGroupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<UpdateVolumeGroupBackupResponse> UpdateVolumeGroupBackup(UpdateVolumeGroupBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<UpdateVolumeKmsKeyResponse> UpdateVolumeKmsKey(UpdateVolumeKmsKeyRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<DeleteVolumeResponse> DeleteVolume(DeleteVolumeRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<DeleteVolumeBackupResponse> DeleteVolumeBackup(DeleteVolumeBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<DeleteVolumeBackupPolicyAssignmentResponse> DeleteVolumeBackupPolicyAssignment(DeleteVolumeBackupPolicyAssignmentRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<DeleteVolumeGroupBackupResponse> DeleteVolumeGroupBackup(DeleteVolumeGroupBackupRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<DeleteVolumeKmsKeyResponse> DeleteVolumeKmsKey(DeleteVolumeKmsKeyRequest param);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        Task<CopyVolumeBackupResponse> CopyVolumeBackup(CopyVolumeBackupRequest param);
    }
}
