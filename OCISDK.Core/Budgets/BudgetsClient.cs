...
namespace OCISDK.Core.Budgets
{
    ...
    public class BudgetsClient : ServiceClient, IBudgetsClient
    {
        ...
        {
            var uri = new Uri($"{GetEndPoint(BudgetsServices.Budgets, this.Region)}/{request.BudgetId}/alertRules");
        ...
        {
            var uri = new Uri($"{GetEndPoint(BudgetsServices.Budgets, this.Region)}");
        ...
        {
            var uri = new Uri($"{GetEndPoint(BudgetsServices.Budgets, this.Region)}/{request.BudgetId}/alertRules/{request.AlertRuleId}");
        ...
        {
            var uri = new Uri($"{GetEndPoint(BudgetsServices.Budgets, this.Region)}/{request.BudgetId}");
        ...
        {
            var uri = new Uri($"{GetEndPoint(BudgetsServices.Budgets, this.Region)}/{request.BudgetId}/alertRules?{request.GetOptionQuery()}");
        ...
        {
            var uri = new Uri($"{GetEndPoint(BudgetsServices.Budgets, this.Region)}?{request.GetOptionQuery()}");
